...
tellraw @a {"rawtext":[{"text":"―――――――――――――――――"}]}
execute @a[tag=host,scores={players=..2}] ~~~ tellraw @a {"rawtext":[{"text":"§bAssassin§r:§b§l "}, {"selector": "@a[tag=hunter,tag=game_is_running]"}]}
execute @a[tag=host,scores={players=3..}] ~~~ tellraw @a {"rawtext":[{"text":"§bAssassins§r:§b§l "}, {"selector": "@a[tag=hunter,tag=game_is_running]"}]}
