...
tellraw @a {"rawtext":[{"text":"―――――――――――――――――"}]}
execute as @a[tag=host,scores={players=..2}] run tellraw @a {"rawtext":[{"text":"§bAssassin§r:§b§l "}, {"selector": "@a[tag=hunter,tag=game_is_running]"}]}
execute as @a[tag=host,scores={players=3..}] run tellraw @a {"rawtext":[{"text":"§bAssassins§r:§b§l "}, {"selector": "@a[tag=hunter,tag=game_is_running]"}]}
...
tellraw @a {"rawtext":[{"text":"§cAssassins have a working compass to track the speedrunner in the same dimension."}]}
