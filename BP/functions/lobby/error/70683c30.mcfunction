# Description: "ph<0"
tellraw @s {"rawtext":[{"text":"§cError: §rThe game could not able to detect players that will become a hunter."}]}
tellraw @s {"rawtext":[{"text":"You need at least 1 player to become a hunter start this game."}]}
